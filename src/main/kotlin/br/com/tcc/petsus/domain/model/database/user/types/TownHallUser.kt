...
import br.com.tcc.petsus.domain.model.api.user.response.TownHallResponse.Companion.townHallResponse
...
data class TownHallUser(
    ...
    override fun response(): UserResponse = this.townHallResponse()
